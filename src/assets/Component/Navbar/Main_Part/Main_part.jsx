...
const Main_part = ({ customerSupports, setCount, setComplateCount,setCustomerSupport }) => {
  ...
  return (
    <div className="max-w-[1300px] mx-auto flex flex-col md:flex-row justify-between gap-5 w-full">
      ...
      <div className="md:flex-1 w-full shadow-2xl">
        ...
        {
          selectedTitle.length === 0 ? <p className="text-black pl-2">
        ...
        selectedTitle.map((item, index) => (
          ...
          >
            <p className="text-black text-[20px] font-semibold pb-1">{item}</p>
          ...
          resolved.map((task, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <p className="text-black"> <i class="fa-solid fa-check"></i> Complete</p>
                <button
